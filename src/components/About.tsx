      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mb-12">
            <span className="font-mono text-sm text-accent-400 tracking-widest uppercase">{'// About'}</span>
          ...
          <div className="glass-card p-8 md:p-12 mb-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="shrink-0">
                <div className="w-28 h-28 bg-gradient-to-br from-accent-500/20 to-violet-500/10 rounded-2xl flex items-center justify-center border border-accent-500/30">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 group">
              <div className="w-12 h-12 bg-accent-500/10 text-accent-400 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:rotate-6 transition-transform duration-300">
